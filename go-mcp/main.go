// Command ExchangeRates-mcp is an MCP server exposing the ExchangeRates
// SDK as MCP tools.
//
// Two tools are registered:
//
//	ExchangeRates_list  — list records of an entity
//	ExchangeRates_load  — load a single record of an entity
//
