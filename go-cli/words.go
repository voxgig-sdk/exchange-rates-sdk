...
func registerSDKWords(r *eng.Registry, client *sdk.ExchangeRatesSDK) {
...
func runOp(client *sdk.ExchangeRatesSDK, op string, query *eng.Value, entityAtom eng.Value) ([]eng.Value, error) {
