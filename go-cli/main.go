// Command ExchangeRates-cli is a CLI + REPL for the ExchangeRates SDK,
...
const prompt = "exchange-rates"

// entitiesHelp is the space-separated entity list shown by /help.
const entitiesHelp = "convert get_api_root get_historical_rate_for_currency_and_date get_historical_rates_for_date latest status symbol timeseries"
...
func usage(out io.Writer) {
	...
	fmt.Fprintln(out, "Env:      EXCHANGE_RATES_APIKEY (api key), EXCHANGE_RATES_BASE (base url override)")
