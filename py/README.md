...
The Python SDK for the ExchangeRates API. Provides an entity-oriented interface following Pythonic conventions.
...
result, err = client.ExchangeRates(None).load(
    {"id": "test01"}, None
)
