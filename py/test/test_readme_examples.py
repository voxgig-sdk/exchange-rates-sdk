# ExchangeRates SDK — documentation python-examples COMPLETENESS gate.
#
...
#      SDK (mentions ExchangeRatesSDK) OR drives a client/sdk variable the narrative
#      built earlier ("client." / "sdk."). A constructing block is rewritten so
#      both ExchangeRatesSDK(...) and ExchangeRatesSDK.test(...) become
#      ExchangeRatesSDK.test({"entity": {...}}) seeding one mock record (id "test01")
...
_SDK_MODULE = "exchangerates_sdk"
_SDK_CLASS = "ExchangeRatesSDK"
...
_ENTITIES = {
    ...
    "GetHistoricalRateForCurrencyAndDate": "get_historical_rate_for_currency_and_date",
    "GetHistoricalRatesForDate": "get_historical_rates_for_date",
    "Latest": "latest",
    "Status": "status",
    "Symbol": "symbol",
