...
from exchangerates_sdk.utility import register

# Load features
from exchangerates_sdk.feature.base_feature import ExchangeRatesBaseFeature
from exchangerates_sdk.features import _has_feature, _make_feature
...
class ExchangeRatesSDK:
    ...
    def __init__(self, options=None):
        ...
        from exchangerates_sdk.config import shared_config
    ...
    def _op_denied(self, op):
        ...
        return {
            "ok": False,
            "err": Exception(
                "ExchangeRatesSDK: " + op + ": operation not allowed by"
    ...
    def graphql(self, query, variables=None, ctrl=None):
        ...
        if isinstance(errors, list) and 0 < len(errors):
            ...
            res["ok"] = False
            res["err"] = Exception("ExchangeRatesSDK: graphql: " + str(msg))
            res["graphql"] = errors
    ...
    def Convert(self, data=None) -> "ConvertEntity":
        ...
        from exchangerates_sdk.entity.convert_entity import ConvertEntity
    ...
    def GetApiRoot(self, data=None) -> "GetApiRootEntity":
        ...
        from exchangerates_sdk.entity.get_api_root_entity import GetApiRootEntity
    ...
    def GetHistoricalRateForCurrencyAndDate(self, data=None) -> "GetHistoricalRateForCurrencyAndDateEntity":
        ...
        from exchangerates_sdk.entity.get_historical_rate_for_currency_and_date_entity import GetHistoricalRateForCurrencyAndDateEntity
    ...
    def GetHistoricalRatesForDate(self, data=None) -> "GetHistoricalRatesForDateEntity":
        ...
        from exchangerates_sdk.entity.get_historical_rates_for_date_entity import GetHistoricalRatesForDateEntity
    ...
    def Latest(self, data=None) -> "LatestEntity":
        ...
        from exchangerates_sdk.entity.latest_entity import LatestEntity
    ...
    def Status(self, data=None) -> "StatusEntity":
        ...
        from exchangerates_sdk.entity.status_entity import StatusEntity
    ...
    def Symbol(self, data=None) -> "SymbolEntity":
        ...
        from exchangerates_sdk.entity.symbol_entity import SymbolEntity
    ...
    def Timeseries(self, data=None) -> "TimeseriesEntity":
        ...
        from exchangerates_sdk.entity.timeseries_entity import TimeseriesEntity
        return TimeseriesEntity(self, data)



    @classmethod
    def test(cls, testopts=None, sdkopts=None) -> "ExchangeRatesSDK":
        if sdkopts is None:
            sdkopts = {}
