...
class GetHistoricalRatesForDateEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return GetHistoricalRatesForDateEntity(self._client, opts)
    ...
    def data_get(self) -> GetHistoricalRatesForDate:
    ...
    def match_get(self) -> GetHistoricalRatesForDate:
    ...
    def load(self, reqmatch=None, ctrl=None) -> GetHistoricalRatesForDate:
        utility = self._utility
        # reqmatch is optional: an entity with no id-like key loads with no
        # match. Treat None as an empty match so client.GetHistoricalRatesForDate().load()
        # works with no args.
        if reqmatch is None:
            reqmatch = {}
