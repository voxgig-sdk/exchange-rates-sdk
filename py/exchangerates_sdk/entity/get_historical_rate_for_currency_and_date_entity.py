...
from exchangerates_sdk.exchangerates_types import (
...
class GetHistoricalRateForCurrencyAndDateEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return GetHistoricalRateForCurrencyAndDateEntity(self._client, opts)
    ...
    def data_get(self) -> GetHistoricalRateForCurrencyAndDate:
    ...
    def match_get(self) -> GetHistoricalRateForCurrencyAndDate:
    ...
    def load(self, reqmatch=None, ctrl=None) -> GetHistoricalRateForCurrencyAndDate:
        utility = self._utility
        # reqmatch is optional: an entity with no id-like key loads with no
        # match. Treat None as an empty match so client.GetHistoricalRateForCurrencyAndDate().load()
        # works with no args.
        if reqmatch is None:
            reqmatch = {}
