...
func NewTimeseriesEntity(client *core.ExchangeRatesSDK, entopts map[string]any) *TimeseriesEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *TimeseriesEntity) GetName() string { return e.name }
...
func (e *TimeseriesEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *TimeseriesEntity) Deleted() bool {
	return e.deleted
}


func (e *TimeseriesEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewTimeseriesEntity(e.client, opts)
}

func (e *TimeseriesEntity) Data(args ...any) any {
...
func (e *TimeseriesEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an Timeseries; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *TimeseriesEntity) DataTyped(data ...Timeseries) Timeseries {
	if len(data) > 0 {
		return typedFrom[Timeseries](e.Data(asMap(data[0])))
	}
	return typedFrom[Timeseries](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through Timeseries (all fields
// optional at the wire level).
func (e *TimeseriesEntity) MatchTyped(match ...Timeseries) Timeseries {
	if len(match) > 0 {
		return typedFrom[Timeseries](e.Match(asMap(match[0])))
	}
	return typedFrom[Timeseries](e.Match())
}
...
func (e *TimeseriesEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *TimeseriesEntity) Load(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// TimeseriesLoadMatch and returns an Timeseries. It delegates to the untyped
// Load (identical runtime) and converts at the typed boundary.
func (e *TimeseriesEntity) LoadTyped(reqmatch TimeseriesLoadMatch, ctrl map[string]any) (Timeseries, error) {
	res, err := e.Load(asMap(reqmatch), ctrl)
	if err != nil {
		return Timeseries{}, err
	}
	return typedFrom[Timeseries](res), nil
}



func (e *TimeseriesEntity) List(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("list", e.name)
}


func (e *TimeseriesEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *TimeseriesEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *TimeseriesEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *TimeseriesEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
