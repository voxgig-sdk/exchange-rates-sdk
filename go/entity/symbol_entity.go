...
func NewSymbolEntity(client *core.ExchangeRatesSDK, entopts map[string]any) *SymbolEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *SymbolEntity) GetName() string { return e.name }
...
func (e *SymbolEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *SymbolEntity) Deleted() bool {
	return e.deleted
}


func (e *SymbolEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewSymbolEntity(e.client, opts)
}

func (e *SymbolEntity) Data(args ...any) any {
...
func (e *SymbolEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an Symbol; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *SymbolEntity) DataTyped(data ...Symbol) Symbol {
	if len(data) > 0 {
		return typedFrom[Symbol](e.Data(asMap(data[0])))
	}
	return typedFrom[Symbol](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through Symbol (all fields
// optional at the wire level).
func (e *SymbolEntity) MatchTyped(match ...Symbol) Symbol {
	if len(match) > 0 {
		return typedFrom[Symbol](e.Match(asMap(match[0])))
	}
	return typedFrom[Symbol](e.Match())
}
...
func (e *SymbolEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *SymbolEntity) Load(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// SymbolLoadMatch and returns an Symbol. It delegates to the untyped
// Load (identical runtime) and converts at the typed boundary.
func (e *SymbolEntity) LoadTyped(reqmatch SymbolLoadMatch, ctrl map[string]any) (Symbol, error) {
	res, err := e.Load(asMap(reqmatch), ctrl)
	if err != nil {
		return Symbol{}, err
	}
	return typedFrom[Symbol](res), nil
}



func (e *SymbolEntity) List(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("list", e.name)
}


func (e *SymbolEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *SymbolEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *SymbolEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *SymbolEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
