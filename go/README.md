...
The Golang SDK for the ExchangeRates API. Provides an entity-oriented interface using standard Go conventions — no generics required, data flows as `map[string]any`.


## Install
```bash
go get github.com/voxgig-sdk/exchange-rates-sdk
```
...
```bash
go mod edit -replace github.com/voxgig-sdk/exchange-rates-sdk=../path/to/github.com/voxgig-sdk/exchange-rates-sdk
```
...
```
github.com/voxgig-sdk/exchange-rates-sdk/
...
The root package (`github.com/voxgig-sdk/exchange-rates-sdk`) re-exports everything needed
