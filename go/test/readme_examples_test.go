...
const testSeed = `map[string]any{"entity": map[string]any{"convert": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "get_api_root": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "get_historical_rate_for_currency_and_date": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "get_historical_rates_for_date": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "latest": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "status": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "symbol": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "timeseries": map[string]any{"example_id": map[string]any{"id": "example_id"}}}}`
