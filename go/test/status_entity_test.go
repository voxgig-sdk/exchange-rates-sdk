...
func TestStatusEntity(t *testing.T) {
	...
	t.Run("basic", func(t *testing.T) {
		...
		if setup.syntheticOnly {
			t.Skip("live entity test uses synthetic IDs from fixture — set EXCHANGERATES_TEST_STATUS_ENTID JSON to run live")
			return
		}
		client := setup.client
...
func statusBasicSetup(extra map[string]any) *entityTestSetup {
	...
	entidEnvRaw := os.Getenv("EXCHANGERATES_TEST_STATUS_ENTID")
	...
	idmapResolved := core.ToMapAny(env["EXCHANGERATES_TEST_STATUS_ENTID"])
