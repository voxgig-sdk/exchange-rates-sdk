...
#      offline in seeded test mode (ExchangeRatesSDK.test) against the real
...
class ReadmeExamplesTest < Minitest::Test
  ...
  SDK = File.join(__dir__, "..", "ExchangeRates_sdk.rb")
  SDK_CLASS = "ExchangeRatesSDK"
