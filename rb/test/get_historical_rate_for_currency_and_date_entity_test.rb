...
class GetHistoricalRateForCurrencyAndDateEntityTest < Minitest::Test
  ...
  def test_basic_flow
    ...
    if setup[:synthetic_only]
      skip "live entity test uses synthetic IDs from fixture — set EXCHANGERATES_TEST_GET_HISTORICAL_RATE_FOR_CURRENCY_AND_DATE_ENTID JSON to run live"
      return
    end
    client = setup[:client]
...
def get_historical_rate_for_currency_and_date_basic_setup(extra)
  ...
  entid_env_raw = ENV["EXCHANGERATES_TEST_GET_HISTORICAL_RATE_FOR_CURRENCY_AND_DATE_ENTID"]
