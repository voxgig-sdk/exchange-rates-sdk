...
class LatestEntityTest < Minitest::Test
  ...
  def test_basic_flow
    ...
    if setup[:synthetic_only]
      skip "live entity test uses synthetic IDs from fixture — set EXCHANGE_RATES_TEST_LATEST_ENTID JSON to run live"
      return
    end
    client = setup[:client]
...
def latest_basic_setup(extra)
  ...
  entid_env_raw = ENV["EXCHANGE_RATES_TEST_LATEST_ENTID"]
