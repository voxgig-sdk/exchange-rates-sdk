...
class StatusEntityTest < Minitest::Test
  ...
  def test_basic_flow
    ...
    if setup[:synthetic_only]
      skip "live entity test uses synthetic IDs from fixture — set EXCHANGE_RATES_TEST_STATUS_ENTID JSON to run live"
      return
    end
    client = setup[:client]
...
def status_basic_setup(extra)
  ...
  entid_env_raw = ENV["EXCHANGE_RATES_TEST_STATUS_ENTID"]
