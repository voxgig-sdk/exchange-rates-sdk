...
class ConvertEntityTest < Minitest::Test
  ...
  def test_basic_flow
    ...
    if setup[:synthetic_only]
      skip "live entity test uses synthetic IDs from fixture — set EXCHANGERATES_TEST_CONVERT_ENTID JSON to run live"
      return
    end
    client = setup[:client]
...
def convert_basic_setup(extra)
  ...
  entid_env_raw = ENV["EXCHANGERATES_TEST_CONVERT_ENTID"]
