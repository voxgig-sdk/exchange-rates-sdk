...
// ExchangeRates SDK utility: graphql
//
...
class ExchangeRatesGraphql
{
    ...
    // equivalent.
    public static function body(ExchangeRatesContext $ctx): mixed
    {
    ...
    public static function errors(ExchangeRatesContext $ctx): bool
    {
        $result = $ctx->result;
        $point = $ctx->point;
