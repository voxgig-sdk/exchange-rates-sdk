...
// ExchangeRates SDK utility: fetcher
...
class ExchangeRatesFetcher
{
    ...
    public const DEFAULT_USER_AGENT = 'Mozilla/5.0 (compatible; ExchangeRatesSDK/1.0)';
    ...
    public static function call(ExchangeRatesContext $ctx, string $fullurl, array $fetchdef): array
    {
