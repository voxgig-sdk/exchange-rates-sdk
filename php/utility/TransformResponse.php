...
// ExchangeRates SDK utility: transform_response

require_once __DIR__ . '/../core/Helpers.php';

class ExchangeRatesTransformResponse
{
    public static function call(ExchangeRatesContext $ctx): mixed
    {
        ...
        $transform = ExchangeRatesHelpers::to_map(\Voxgig\Struct\Struct::getprop($point, 'transform'));
        if (!$transform) {
            return null;
        }
