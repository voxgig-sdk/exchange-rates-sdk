...
// ExchangeRates SDK Timeseries entity
...
class TimeseriesEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new TimeseriesEntity($this->_client, $opts);
    }

    /**
     * @param Timeseries|array $args Timeseries data (assoc-array) to store.
     */
    ...
    /**
     * @return Timeseries|array The current Timeseries data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of Timeseries fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of Timeseries fields).
     */
    ...
    /**
     * Load a single Timeseries.
     *
     * @param TimeseriesLoadMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; a typed TimeseriesLoadMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Timeseries|array The loaded Timeseries as an assoc-array at the
