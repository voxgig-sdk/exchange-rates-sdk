...
$client = ExchangeRatesSDK::test([
    "entity" => ["gethistoricalratesfordate" => ["test01" => ["id" => "test01"]]],
]);

// Entity ops return the ENTITY (throws on error);
// call data_get() for the mock record.
$gethistoricalratesfordate = $client->GetHistoricalRatesForDate()->load(["id" => "test01"]);
print_r($gethistoricalratesfordate->data_get());
```
