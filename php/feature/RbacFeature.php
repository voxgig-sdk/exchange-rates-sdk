...
// ExchangeRates SDK rbac feature
...
class ExchangeRatesRbacFeature extends ExchangeRatesBaseFeature
{
    ...
    private function _required(ExchangeRatesContext $ctx): ?string
    {
    ...
    private function _reject(ExchangeRatesContext $ctx, string $required): void
    {
    ...
    private function _track(ExchangeRatesContext $ctx, string $required, bool $allowed): void
    {
        $client = $this->client;
