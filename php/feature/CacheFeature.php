...
// ExchangeRates SDK cache feature
...
class ExchangeRatesCacheFeature extends ExchangeRatesBaseFeature
{
    ...
    private function _through(ExchangeRatesContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
