...
// ExchangeRates SDK timeout feature
...
class ExchangeRatesTimeoutFeature extends ExchangeRatesBaseFeature
{
    ...
    private function _with_timeout(ExchangeRatesContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
    ...
    private function _track(ExchangeRatesContext $_ctx, float $ms): void
    {
        $client = $this->client;
