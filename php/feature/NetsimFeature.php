...
// ExchangeRates SDK netsim feature
...
class ExchangeRatesNetsimFeature extends ExchangeRatesBaseFeature
{
    ...
    private function _simulate(ExchangeRatesContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
        $opts = $this->options ?? [];
        $this->calls++;
        $call = $this->calls;
    ...
    private function _track(ExchangeRatesContext $ctx, array $applied): void
    {
        $client = $this->client;
