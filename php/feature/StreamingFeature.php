...
// ExchangeRates SDK streaming feature
...
class ExchangeRatesStreamingFeature extends ExchangeRatesBaseFeature
{
    ...
    private function _iterate(ExchangeRatesResult $result): \Generator
    {
    ...
    private function _streamable(ExchangeRatesContext $ctx): bool
    {
