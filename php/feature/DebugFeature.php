...
// ExchangeRates SDK debug feature
...
class ExchangeRatesDebugFeature extends ExchangeRatesBaseFeature
{
    ...
    private function _finish(ExchangeRatesContext $ctx, bool $ok): void
    {
