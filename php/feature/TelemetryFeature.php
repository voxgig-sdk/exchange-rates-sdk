...
// ExchangeRates SDK telemetry feature
...
class ExchangeRatesTelemetryFeature extends ExchangeRatesBaseFeature
{
    ...
    private function _close(ExchangeRatesContext $ctx, bool $ok): void
    {
