...
class LatestEntityTest extends TestCase
{
    ...
    public function test_basic_flow(): void
    {
        ...
        if (!empty($setup["synthetic_only"])) {
            $this->markTestSkipped("live entity test uses synthetic IDs from fixture — set EXCHANGERATES_TEST_LATEST_ENTID JSON to run live");
            return;
        }
        $client = $setup["client"];
...
function latest_basic_setup($extra)
{
    ...
    $entid_env_raw = getenv("EXCHANGERATES_TEST_LATEST_ENTID");
    ...
    $idmap_resolved = Helpers::to_map(
        $env["EXCHANGERATES_TEST_LATEST_ENTID"]);
