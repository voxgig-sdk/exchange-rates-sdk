...
class TimeseriesDirectTest extends TestCase
{
    public function test_direct_load_timeseries(): void
    {
        $setup = timeseries_direct_setup(["id" => "direct01"]);
        [$_shouldSkip, $_reason] = Runner::is_control_skipped("direct", "direct-load-timeseries", $setup["live"] ? "live" : "unit");
        if ($_shouldSkip) {
