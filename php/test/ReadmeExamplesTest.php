...
// ExchangeRates SDK — documentation example COMPLETENESS GATE.
//
...
//      EXECUTED offline in seeded test mode (ExchangeRatesSDK::test)
...
{
    private const SDK_CLASS = 'ExchangeRatesSDK';
    ...
    private const SDK_BASE = 'exchangerates_sdk';
    ...
    public function test_php_examples_run_offline(): void
    {
        $ran = 0;
        $failures = [];
        $sdk = __DIR__ . '/../exchangerates_sdk.php';
        foreach ($this->phpBlocks() as $blk) {
