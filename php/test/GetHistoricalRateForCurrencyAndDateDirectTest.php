...
class GetHistoricalRateForCurrencyAndDateDirectTest extends TestCase
{
    public function test_direct_load_get_historical_rate_for_currency_and_date(): void
    {
        $setup = get_historical_rate_for_currency_and_date_direct_setup(["id" => "direct01"]);
        [$_shouldSkip, $_reason] = Runner::is_control_skipped("direct", "direct-load-get_historical_rate_for_currency_and_date", $setup["live"] ? "live" : "unit");
        if ($_shouldSkip) {
