...
(0, node_test_1.describe)('SymbolDirect', async () => {
    ...
    (0, node_test_1.test)('direct-load-symbol', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup({ id: 'direct01' });
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-load-symbol', setup.live))
            return;
...
function directSetup(mockres) {
    ...
    if (live) {
        ...
        let idmap = env['EXCHANGE_RATES_TEST_SYMBOL_ENTID'];
...
//# sourceMappingURL=SymbolDirect.test.js.map