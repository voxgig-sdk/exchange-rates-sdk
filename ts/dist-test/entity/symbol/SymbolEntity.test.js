...
(0, node_test_1.describe)('SymbolEntity', async () => {
    ...
    (0, node_test_1.test)('basic', async (t) => {
        ...
        let symbol_ref01_data = Object.values(setup.data.existing.symbol)[0];
        // LOAD
        const symbol_ref01_ent = client.Symbol();
        const symbol_ref01_match_dt0 = {};
        const symbol_ref01_data_dt0 = (await symbol_ref01_ent.load(symbol_ref01_match_dt0)).data();
        (0, node_assert_1.default)(null != symbol_ref01_data_dt0);
    });
});
function basicSetup(extra) {
    ...
    const entityDataFile = node_path_1.default.resolve(__dirname, '../../../../.sdk/test/entity/symbol/SymbolTestData.json');
    ...
    let idmap = transform(['symbol01', 'symbol02', 'symbol03'], {
        '`$PACK`': ['', {
                '`$KEY`': '`$COPY`',
...
//# sourceMappingURL=SymbolEntity.test.js.map