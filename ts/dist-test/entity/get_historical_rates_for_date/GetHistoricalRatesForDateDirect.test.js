...
(0, node_test_1.describe)('GetHistoricalRatesForDateDirect', async () => {
    ...
    (0, node_test_1.test)('direct-load-get_historical_rates_for_date', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup({ id: 'direct01' });
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-load-get_historical_rates_for_date', setup.live))
            return;
...
function directSetup(mockres) {
    ...
    if (live) {
        ...
        let idmap = env['EXCHANGE_RATES_TEST_GET_HISTORICAL_RATES_FOR_DATE_ENTID'];
...
//# sourceMappingURL=GetHistoricalRatesForDateDirect.test.js.map