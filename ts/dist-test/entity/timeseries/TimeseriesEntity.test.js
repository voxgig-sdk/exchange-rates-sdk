...
(0, node_test_1.describe)('TimeseriesEntity', async () => {
    ...
    (0, node_test_1.test)('basic', async (t) => {
        ...
        for (const op of ['load']) {
            if ((0, utility_1.maybeSkipControl)(t, 'entityOp', 'timeseries.' + op, live))
                return;
        }
        ...
        let timeseries_ref01_data = Object.values(setup.data.existing.timeseries)[0];
        // LOAD
        const timeseries_ref01_ent = client.Timeseries();
        const timeseries_ref01_match_dt0 = {};
        const timeseries_ref01_data_dt0 = (await timeseries_ref01_ent.load(timeseries_ref01_match_dt0)).data();
        (0, node_assert_1.default)(null != timeseries_ref01_data_dt0);
    });
});
function basicSetup(extra) {
    ...
    const entityDataFile = node_path_1.default.resolve(__dirname, '../../../../.sdk/test/entity/timeseries/TimeseriesTestData.json');
    ...
    let idmap = transform(['timeseries01', 'timeseries02', 'timeseries03'], {
        '`$PACK`': ['', {
                '`$KEY`': '`$COPY`',
    ...
    const idmapEnvVal = process.env['EXCHANGE_RATES_TEST_TIMESERIES_ENTID'];
...
//# sourceMappingURL=TimeseriesEntity.test.js.map