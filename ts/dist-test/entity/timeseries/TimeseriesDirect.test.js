...
(0, node_test_1.describe)('TimeseriesDirect', async () => {
    ...
    (0, node_test_1.test)('direct-load-timeseries', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup({ id: 'direct01' });
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-load-timeseries', setup.live))
            return;
...
function directSetup(mockres) {
    ...
    const env = (0, utility_1.envOverride)({
        'EXCHANGE_RATES_TEST_TIMESERIES_ENTID': {},
    ...
    if (live) {
        ...
        let idmap = env['EXCHANGE_RATES_TEST_TIMESERIES_ENTID'];
...
//# sourceMappingURL=TimeseriesDirect.test.js.map