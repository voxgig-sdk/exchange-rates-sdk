...
describe('GetHistoricalRatesForDateEntity', async () => {
  ...
  test('basic', async (t) => {
    ...
    for (const op of ['load']) {
      if (!live && maybeSkipControl(t, 'entityOp', 'get_historical_rates_for_date.' + op, live)) return
    }
...
function basicSetup(extra?: any) {
  ...
  const entityDataFile =
    Path.resolve(__dirname, 
      '../../../../.sdk/test/entity/get_historical_rates_for_date/GetHistoricalRatesForDateTestData.json')
