...
class GetHistoricalRatesForDateEntity extends ExchangeRatesEntityBase<GetHistoricalRatesForDate> {
  ...
  make(this: GetHistoricalRatesForDateEntity) {
    return new GetHistoricalRatesForDateEntity(this._client, this.entopts())
  }



  async load(this: any, reqmatch?: GetHistoricalRatesForDateLoadMatch, ctrl?: Control): Promise<GetHistoricalRatesForDateEntity> {
