...
class ExchangeRatesSDK {
  ...
  async graphql(query: string, variables?: any, ctrl?: any) {
    ...
    if (null != errors && Array.isArray(errors) && 0 < errors.length) {
      ...
      const err: any = new Error('ExchangeRatesSDK: graphql: ' +
  ...
  // The argument is the entity OPTIONS object (passed to the entity
  // constructor as entopts), not initial entity data.
  GetHistoricalRateForCurrencyAndDate(entopts?: Record<string, any>) {
    const self = this
    return new GetHistoricalRateForCurrencyAndDateEntity(self, entopts)
  }
  ...
  // The argument is the entity OPTIONS object (passed to the entity
  // constructor as entopts), not initial entity data.
  GetHistoricalRatesForDate(entopts?: Record<string, any>) {
    const self = this
    return new GetHistoricalRatesForDateEntity(self, entopts)
  }
  ...
  // The argument is the entity OPTIONS object (passed to the entity
  // constructor as entopts), not initial entity data.
  Symbol(entopts?: Record<string, any>) {
    const self = this
    return new SymbolEntity(self, entopts)
  }
  ...
  // The argument is the entity OPTIONS object (passed to the entity
  // constructor as entopts), not initial entity data.
  Timeseries(entopts?: Record<string, any>) {
    const self = this
    return new TimeseriesEntity(self, entopts)
  }
