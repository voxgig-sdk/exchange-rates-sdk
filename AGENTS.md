...
**Entities** (8): `Convert`, `GetApiRoot`, `GetHistoricalRateForCurrencyAndDate`, `GetHistoricalRatesForDate`, `Latest`, `Status`, `Symbol`, `Timeseries`.
