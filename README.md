...
Official Reserve Bank of Australia (RBA) exchange rate data through a modern REST API.

Learn more about RBA Exchange Rates API at [exchangeratesapi.com.au](https://exchangeratesapi.com.au).
