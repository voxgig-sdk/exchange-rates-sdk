...
| --- | --- | --- |
| TypeScript | `@voxgig-sdk/exchange-rates` | `npm install @voxgig-sdk/exchange-rates` |
| Python | `voxgig-sdk-exchange-rates` | `pip install voxgig-sdk-exchange-rates` |
| PHP | `voxgig-sdk/exchange-rates` | `composer require voxgig-sdk/exchange-rates` |
| Golang | `github.com/voxgig-sdk/exchange-rates-sdk/go` | `go get github.com/voxgig-sdk/exchange-rates-sdk/go` |
| Ruby | `voxgig-sdk-exchange-rates` | `gem install voxgig-sdk-exchange-rates` |
| Lua | `voxgig-sdk-exchange-rates` | `luarocks install voxgig-sdk-exchange-rates` |
