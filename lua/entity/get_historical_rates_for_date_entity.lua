...
local GetHistoricalRatesForDateEntity = {}
GetHistoricalRatesForDateEntity.__index = GetHistoricalRatesForDateEntity


function GetHistoricalRatesForDateEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, GetHistoricalRatesForDateEntity)
  self._name = "get_historical_rates_for_date"
  self._client = client
...
function GetHistoricalRatesForDateEntity:get_name()
  return self._name
end


function GetHistoricalRatesForDateEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return GetHistoricalRatesForDateEntity.new(self._client, opts)
end
...
function GetHistoricalRatesForDateEntity:mark_deleted()
  self._deleted = true
end


function GetHistoricalRatesForDateEntity:deleted()
  return true == self._deleted
end


function GetHistoricalRatesForDateEntity:data_set(args)
  if args ~= nil then
...
function GetHistoricalRatesForDateEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function GetHistoricalRatesForDateEntity:match_set(args)
  if args ~= nil then
...
function GetHistoricalRatesForDateEntity:match_get()
...
function GetHistoricalRatesForDateEntity:stream(action, args, callopts)
...
function GetHistoricalRatesForDateEntity:_run_op(ctx, post_done)
  local utility = self._utility
...
return GetHistoricalRatesForDateEntity
