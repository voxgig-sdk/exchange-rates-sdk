...
local SDK_MODULE = "exchange-rates_sdk"
...
-- data to return.
local TEST_SEED = '{ entity = { ["convert"] = { ["test01"] = { id = "test01" } }, ["get_api_root"] = { ["test01"] = { id = "test01" } }, ["get_historical_rate_for_currency_and_date"] = { ["test01"] = { id = "test01" } }, ["get_historical_rates_for_date"] = { ["test01"] = { id = "test01" } }, ["latest"] = { ["test01"] = { id = "test01" } }, ["status"] = { ["test01"] = { id = "test01" } }, ["symbol"] = { ["test01"] = { id = "test01" } }, ["timeseries"] = { ["test01"] = { id = "test01" } } } }'
