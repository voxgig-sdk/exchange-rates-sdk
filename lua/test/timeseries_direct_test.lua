...
describe("TimeseriesDirect", function()
  it("should direct-load-timeseries", function()
    local setup = timeseries_direct_setup({ id = "direct01" })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-load-timeseries", setup.live and "live" or "unit")
...
function timeseries_direct_setup(mockres)
