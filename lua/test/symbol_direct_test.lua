...
describe("SymbolDirect", function()
  it("should direct-load-symbol", function()
    local setup = symbol_direct_setup({ id = "direct01" })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-load-symbol", setup.live and "live" or "unit")
...
function symbol_direct_setup(mockres)
