-- GetHistoricalRatesForDate direct test
...
describe("GetHistoricalRatesForDateDirect", function()
  it("should direct-load-get_historical_rates_for_date", function()
    local setup = get_historical_rates_for_date_direct_setup({ id = "direct01" })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-load-get_historical_rates_for_date", setup.live and "live" or "unit")
...
function get_historical_rates_for_date_direct_setup(mockres)
