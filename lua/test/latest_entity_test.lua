...
describe("LatestEntity", function()
  ...
  it("should run basic flow", function()
    ...
    if setup.synthetic_only then
      pending("live entity test uses synthetic IDs from fixture — set EXCHANGERATES_TEST_LATEST_ENTID JSON to run live")
      return
    end
...
function latest_basic_setup(extra)
  ...
  local entid_env_raw = os.getenv("EXCHANGERATES_TEST_LATEST_ENTID")
