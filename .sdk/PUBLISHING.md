...
|---|---|---|
| `ts/` | @voxgig-sdk/exchange-rates-sdk | `.github/workflows/publish-ts.yml` |
...
required):
    ...
    npm trust github @voxgig-sdk/exchange-rates-sdk \
      --repository voxgig-sdk/exchange-rates-sdk \
      --file publish-ts.yml \
      --allow-publish

Then `npm trust list @voxgig-sdk/exchange-rates-sdk` shows it, and
`npm trust revoke @voxgig-sdk/exchange-rates-sdk --id=<id>` removes it.
