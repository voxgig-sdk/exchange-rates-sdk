...
// ExchangeRates SDK pipeline test
//
...
{
    private static function utility(): ExchangeRatesUtility
    {
        return new ExchangeRatesUtility();
    }
    ...
    private static function ctx(array $over = []): ExchangeRatesContext
    {
        $utility = $over['utility'] ?? self::utility();
        $client = $over['client'] ?? new PlClient(['base' => 'http://h']);
        $ctx = new ExchangeRatesContext([
            'client' => $client,
            'utility' => $utility,
        ], null);
        $ctx->op = new ExchangeRatesOperation(['name' => 'load', 'entity' => 'x']);
        foreach ($over as $k => $v) {
    ...
    {
        return ($err instanceof ExchangeRatesError) ? $err->sdk_code : '';
    }
    ...
    public function test_make_point_rejects_a_disallowed_operation(): void
    {
        ...
        $ctx->op = new ExchangeRatesOperation(['name' => 'nope', 'entity' => 'x']);
        [$point, $err] = ExchangeRatesMakePoint::call($ctx);
    ...
    public function test_make_point_rejects_an_operation_with_no_endpoints(): void
    {
        ...
        $ctx->op = new ExchangeRatesOperation(['name' => 'load', 'entity' => 'x', 'points' => []]);
        [$point, $err] = ExchangeRatesMakePoint::call($ctx);
        $this->assertNull($point);
    ...
    public function test_make_point_returns_the_single_point(): void
    {
        ...
        $ctx = self::ctx(['options' => ['allow' => ['op' => 'load,list,create,update,remove']]]);
        $ctx->op = new ExchangeRatesOperation(['name' => 'load', 'entity' => 'x', 'points' => [$point]]);
        [$got, $err] = ExchangeRatesMakePoint::call($ctx);
        $this->assertNull($err);
    ...
    {
        $preset = new ExchangeRatesSpec(['method' => 'GET']);
        $ctx = self::ctx();
        $ctx->out['spec'] = $preset;
        [$got, $err] = ExchangeRatesMakeSpec::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    public function test_make_response_guards_missing_spec_response_result(): void
    {
        $ctx = self::ctx([
            'spec' => null,
            'response' => new ExchangeRatesResponse([]),
            'result' => new ExchangeRatesResult([]),
        ]);
        [, $err] = ExchangeRatesMakeResponse::call($ctx);
        $this->assertSame('response_no_spec', self::code($err));

        $ctx = self::ctx([
            'spec' => new ExchangeRatesSpec([]),
            'response' => null,
            'result' => new ExchangeRatesResult([]),
        ]);
        [, $err] = ExchangeRatesMakeResponse::call($ctx);
    ...
    {
        $ctx = self::ctx([
            'spec' => new ExchangeRatesSpec(['step' => 's']),
            'response' => new ExchangeRatesResponse(self::resp(404, null, ['x-a' => '1'])),
            'result' => new ExchangeRatesResult([]),
        ]);
        [, $err] = ExchangeRatesMakeResponse::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_response_2xx_parses_the_body_and_marks_ok(): void
    {
        $ctx = self::ctx([
            'spec' => new ExchangeRatesSpec(['step' => 's']),
            'response' => new ExchangeRatesResponse(self::resp(200, ['v' => 1])),
            'result' => new ExchangeRatesResult([]),
        ]);
        [, $err] = ExchangeRatesMakeResponse::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_response_records_to_ctrl_explain_when_explain_is_on(): void
    {
        $ctx = self::ctx([
            'spec' => new ExchangeRatesSpec(['step' => 's']),
            'response' => new ExchangeRatesResponse(self::resp(200, ['v' => 2])),
            'result' => new ExchangeRatesResult([]),
        ]);
        $ctx->ctrl->explain = ['on' => true];
        ExchangeRatesMakeResponse::call($ctx);
    ...
    {
        $preset = new ExchangeRatesResponse(self::resp(299));
        $ctx = self::ctx([
            'spec' => new ExchangeRatesSpec([]),
            'response' => new ExchangeRatesResponse([]),
            'result' => new ExchangeRatesResult([]),
        ...
        [$got, $err] = ExchangeRatesMakeResponse::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    {
        $ctx = self::ctx(['spec' => null, 'result' => new ExchangeRatesResult([])]);
        [, $err] = ExchangeRatesMakeResult::call($ctx);
        $this->assertSame('result_no_spec', self::code($err));

        $ctx = self::ctx(['spec' => new ExchangeRatesSpec([]), 'result' => null]);
        [, $err] = ExchangeRatesMakeResult::call($ctx);
    ...
    public function test_make_result_list_op_wraps_resdata_into_entity_instances(): void
    {
        ...
        $ctx = self::ctx([
            'entity' => $entity,
            'spec' => new ExchangeRatesSpec(['step' => 's']),
            'result' => new ExchangeRatesResult(['ok' => true, 'resdata' => [['a' => 1], ['a' => 2]]]),
        ]);
        $ctx->op = new ExchangeRatesOperation(['name' => 'list', 'entity' => 'x']);
        [$result, $err] = ExchangeRatesMakeResult::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_result_empty_list_yields_empty_resdata(): void
    {
        ...
        $ctx = self::ctx([
            'entity' => $entity,
            'spec' => new ExchangeRatesSpec(['step' => 's']),
            'result' => new ExchangeRatesResult(['ok' => true, 'resdata' => []]),
        ]);
        $ctx->op = new ExchangeRatesOperation(['name' => 'list', 'entity' => 'x']);
        [$result, $err] = ExchangeRatesMakeResult::call($ctx);
        $this->assertNull($err);
    ...
    {
        $preset = new ExchangeRatesResult(['ok' => true]);
        $ctx = self::ctx([
            'spec' => new ExchangeRatesSpec([]),
            'result' => new ExchangeRatesResult([]),
        ]);
        $ctx->out['result'] = $preset;
        [$got, $err] = ExchangeRatesMakeResult::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    public function test_make_request_guards_a_missing_spec(): void
    {
        ...
        [, $err] = ExchangeRatesMakeRequest::call($ctx);
    ...
    {
        $utility = self::utility();
        $boom = new ExchangeRatesError('boom', 'boom');
        $utility->fetcher = function (ExchangeRatesContext $_c, string $_u, array $_f) use ($boom): array {
            return [null, $boom];
        };
        $ctx = self::ctx([
            'utility' => $utility,
            'spec' => new ExchangeRatesSpec(['step' => 's', 'method' => 'GET', 'base' => 'http://h', 'parts' => ['a']]),
        ]);
        [$response, $err] = ExchangeRatesMakeRequest::call($ctx);
        $this->assertNull($err);
    ...
    {
        $utility = self::utility();
        $utility->fetcher = function (ExchangeRatesContext $_c, string $_u, array $_f): array {
            return [null, null];
        };
        $ctx = self::ctx([
            'utility' => $utility,
    ...
    public function test_make_request_a_normal_transport_response_is_wrapped(): void
    {
        ...
        [$response, $err] = ExchangeRatesMakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertInstanceOf(ExchangeRatesResponse::class, $response);
    ...
    public function test_make_request_records_the_fetchdef_to_ctrl_explain(): void
    {
        ...
        $ctx->ctrl->explain = ['on' => true];
        ExchangeRatesMakeRequest::call($ctx);
    ...
    {
        $utility = self::utility();
        $utility->make_fetch_def = function (ExchangeRatesContext $c): array {
            return [null, $c->make_error('fetchdef_boom', 'boom')];
        };
        $ctx = self::ctx([
            'utility' => $utility,
            'spec' => new ExchangeRatesSpec(['step' => 's', 'method' => 'GET']),
        ]);
        [$response, $err] = ExchangeRatesMakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertNotNull($response->err);
    ...
    {
        $preset = new ExchangeRatesResponse(self::resp(201));
        $ctx = self::ctx(['spec' => new ExchangeRatesSpec([])]);
        $ctx->out['request'] = $preset;
        [$got, $err] = ExchangeRatesMakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    {
        $ctx = self::ctx(['spec' => null]);
        [, $err] = ExchangeRatesMakeFetchDef::call($ctx);
    ...
    public function test_make_fetch_def_serialises_body_and_inits_missing_result(): void
    {
        ...
        [$fetchdef, $err] = ExchangeRatesMakeFetchDef::call($ctx);
        $this->assertNull($err);
    ...
    {
        $ctx = self::ctx(['result' => new ExchangeRatesResult(['ok' => true, 'resdata' => 42])]);
        $this->assertSame(42, ExchangeRatesDone::call($ctx));
    }

    public function test_done_raises_the_error_when_not_ok(): void
    {
        $ctx = self::ctx(['result' => new ExchangeRatesResult(['ok' => false])]);
        $this->expectException(ExchangeRatesError::class);
        ExchangeRatesDone::call($ctx);
    }

    public function test_make_error_returns_resdata_when_ctrl_throw_is_false(): void
    {
        $ctx = self::ctx(['result' => new ExchangeRatesResult(['ok' => false, 'resdata' => 'fallback'])]);
        $ctx->ctrl->throw_err = false;
        $this->assertSame('fallback', ExchangeRatesMakeError::call($ctx, null));
    }
    ...
    public function test_make_error_records_to_ctrl_explain(): void
    {
        ...
        $ctx->ctrl->throw_err = false;
        $ctx->ctrl->explain = ['on' => true];
        ExchangeRatesMakeError::call($ctx, null);
    ...
    public function test_feature_add_appends_in_call_order(): void
    {
        ...
        $a = new ExchangeRatesBaseFeature();
        $b = new ExchangeRatesBaseFeature();
        ExchangeRatesFeatureAdd::call($ctx, $a);
        ExchangeRatesFeatureAdd::call($ctx, $b);
        $this->assertSame([$a, $b], $client->features);
    }

    private static function named_feature(string $name): ExchangeRatesBaseFeature
    {
        $f = new ExchangeRatesBaseFeature();
        $f->name = $name;
        return $f;
    }
    ...
    public function test_feature_add_ordering_before_after_replace(): void
    {
        ...
        ExchangeRatesFeatureAdd::call($ctx, $miss);
    ...
    private static function auth_ctx(array $options, ?array $headers): ExchangeRatesContext
    {
        $client = new PlClient($options);
        return self::ctx([
            'client' => $client,
            'spec' => $headers === null ? null : new ExchangeRatesSpec(['headers' => $headers]),
        ]);
    }
    ...
    public function test_prepare_auth_guards_a_missing_spec(): void
    {
        ...
        [, $err] = ExchangeRatesPrepareAuth::call($ctx);
    ...
    public function test_prepare_auth_a_raw_apikey_goes_in_as_is(): void
    {
        ...
        ExchangeRatesPrepareAuth::call($ctx);
    ...
    {
        $ctx = self::ctx([
            'response' => new ExchangeRatesResponse(['headers' => null]),
            'result' => new ExchangeRatesResult([]),
        ]);
        ExchangeRatesResultHeaders::call($ctx);
    ...
    public function test_result_body_skips_parsing_when_the_body_is_absent(): void
    {
        ...
        ExchangeRatesResultBody::call($ctx);
