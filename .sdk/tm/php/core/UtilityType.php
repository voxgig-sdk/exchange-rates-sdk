...
// ExchangeRates SDK utility type

class ExchangeRatesUtility
{
    ...
    public static function copy(ExchangeRatesUtility $src): ExchangeRatesUtility
    {
        $u = new ExchangeRatesUtility();
        $u->clean = $src->clean;
        $u->done = $src->done;
