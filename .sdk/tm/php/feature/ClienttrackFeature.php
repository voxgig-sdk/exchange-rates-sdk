...
// ExchangeRates SDK clienttrack feature
...
class ExchangeRatesClienttrackFeature extends ExchangeRatesBaseFeature
{
    ...
    public function PostConstruct(ExchangeRatesContext $_ctx): void
    {
        if (!$this->active) {
            return;
        }
    ...
    private function _name(): string
    {
        ...
        $name = (is_string($name) && $name !== '') ? $name : 'ExchangeRates-SDK';
