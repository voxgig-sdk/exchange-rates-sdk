...
// ExchangeRates SDK audit feature
...
class ExchangeRatesAuditFeature extends ExchangeRatesBaseFeature
{
    ...
    private function _emit(ExchangeRatesContext $ctx, string $outcome): void
    {
