...
// ExchangeRates SDK proxy feature
...
class ExchangeRatesProxyFeature extends ExchangeRatesBaseFeature
{
    ...
    public function init(ExchangeRatesContext $ctx, array $options): void
    {
        ...
        $utility->fetcher = function (ExchangeRatesContext $ctx2, string $url2, array $fetchdef) use ($inner): array {
