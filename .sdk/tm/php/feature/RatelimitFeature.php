...
// ExchangeRates SDK ratelimit feature
...
class ExchangeRatesRatelimitFeature extends ExchangeRatesBaseFeature
{
    ...
    private function _acquire(ExchangeRatesContext $ctx): void
    {
    ...
    private function _track(ExchangeRatesContext $_ctx, float $wait_ms): void
    {
        $client = $this->client;
