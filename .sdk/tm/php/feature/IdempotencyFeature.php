...
// ExchangeRates SDK idempotency feature
...
class ExchangeRatesIdempotencyFeature extends ExchangeRatesBaseFeature
{
    ...
    private function _mutating(ExchangeRatesContext $ctx): bool
    {
