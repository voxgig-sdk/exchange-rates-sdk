...
// ExchangeRates SDK metrics feature
...
class ExchangeRatesMetricsFeature extends ExchangeRatesBaseFeature
{
    ...
    private function _record(ExchangeRatesContext $ctx, bool $ok): void
    {
