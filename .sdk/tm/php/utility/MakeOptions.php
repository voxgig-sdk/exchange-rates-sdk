...
// ExchangeRates SDK utility: make_options

class ExchangeRatesMakeOptions
{
    ...
    public static function call(ExchangeRatesContext $ctx): array
    {
        ...
        //
        // `ExchangeRatesSchema::optspec()` is built from the model:
        ...
        $optspec = ExchangeRatesSchema::optspec();
