...
from projectname_sdk.core.control import ExchangeRatesControl
...
class ExchangeRatesContext:
    def __init__(self, ctxmap=None, basectx=None):
        ...
        # Ctrl
        self.ctrl = ExchangeRatesControl()
        ...
        if isinstance(sp, ExchangeRatesSpec):
            self.spec = sp
        elif basectx is not None:
        ...
        if isinstance(r, ExchangeRatesResult):
            self.result = r
        elif basectx is not None:
        ...
        if isinstance(rp, ExchangeRatesResponse):
            self.response = rp
        elif basectx is not None:
    ...
    def make_error(self, code, msg):
        return ExchangeRatesError(code, msg, self)
